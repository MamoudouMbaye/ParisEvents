        ...
        return (
            <div className="pages-background search">
                ...
                <main className="search-main">
                    <h1 className="title-large">Les évènements À venir</h1>
                    <form className="search-bar__container">
                        <span>
                            <input type="text" ref={inputRef} placeholder="Tapez votre mot clé" id="search-bar" name="search" onKeyPress={onKeyPress} />
                        </span>
